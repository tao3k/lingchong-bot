...
The project uses the default `rust-lang-project-harness` gate. Do not pass
`advice = allow` or similar escape options in this repository. Policy output
should drive immediate repair in the touched scope.
